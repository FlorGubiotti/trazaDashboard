...
public class SucursalController extends BaseControllerImp<Sucursal, SucursalDto,Long, SucursalFacadeImp> {
    ...
    public ResponseEntity<List<SucursalDto>> findAllByEmpresa(@PathVariable Long companyId) {
        return ResponseEntity.ok().body(facade.findSurcursalesByEmpresa(companyId));
    }
